...
class psycopg:
    def __init__(self,dbname,username='test_user',autocom=False, tablenames=None):
        if _platform == "linux" or _platform == "linux2":
            self.connection = psycopg2.connect("dbname='{}' user='{}'".format(dbname, username))
        elif _platform == "cygwin":
            self.connection=psycopg2.connect(database=dbname, user=username, host="127.0.0.1", password="test_password")
